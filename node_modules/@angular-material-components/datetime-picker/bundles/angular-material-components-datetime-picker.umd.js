(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/coercion'), require('@angular/cdk/overlay'), require('@angular/cdk/bidi'), require('rxjs/operators'), require('@angular/cdk/keycodes'), require('@angular/material/form-field'), require('rxjs'), require('@angular/cdk/portal'), require('@angular/material/datepicker'), require('@angular/material/dialog'), require('@angular/common'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/core'), require('@angular/cdk/platform'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@angular-material-components/datetime-picker', ['exports', '@angular/cdk/coercion', '@angular/cdk/overlay', '@angular/cdk/bidi', 'rxjs/operators', '@angular/cdk/keycodes', '@angular/material/form-field', 'rxjs', '@angular/cdk/portal', '@angular/material/datepicker', '@angular/material/dialog', '@angular/common', '@angular/forms', '@angular/material/button', '@angular/material/icon', '@angular/material/input', '@angular/material/core', '@angular/cdk/platform', '@angular/core'], factory) :
    (factory((global['angular-material-components'] = global['angular-material-components'] || {}, global['angular-material-components']['datetime-picker'] = {}),global.ng.cdk.coercion,global.ng.cdk.overlay,global.ng.cdk.bidi,global.rxjs.operators,global.ng.cdk.keycodes,global.ng.material['form-field'],global.rxjs,global.ng.cdk.portal,global.ng.material.datepicker,global.ng.material.dialog,global.ng.common,global.ng.forms,global.ng.material.button,global.ng.material.icon,global.ng.material.input,global.ng.material.core,global.ng.cdk.platform,global.ng.core));
}(this, (function (exports,coercion,overlay,bidi,operators,keycodes,formField,rxjs,portal,datepicker,dialog,common,forms,button,icon,input,core,platform,core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxMatMonthView = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatMonthView.ctorParameters = function () {
            return [
        ...
        NgxMatMonthView.propDecorators = {
            ...
            _matCalendarBody: [{ type: core$1.ViewChild, args: [datepicker.MatCalendarBody,] }]
        };
    ...
    var NgxMatMultiYearView = /** @class */ (function () {
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype.ngAfterContentInit = /**
         * @return {?}
         */
            function () {
                this._init();
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._init = /**
         * Initializes this multi-year view.
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._yearSelected = /**
         * Handles when a new year is selected.
         * @param {?} year
         * @return {?}
         */
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._handleCalendarBodyKeydown = /**
         * Handles keydown events on the calendar body when calendar is in multi-year view.
         * @param {?} event
         * @return {?}
         */
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._getActiveCell = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._focusActiveCell = /**
         * Focuses the active cell after the microtask queue is empty.
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._createCellForYear = /**
         * Creates an MatCalendarCell for the given year.
         * @private
         * @param {?} year
         * @return {?}
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._shouldEnableYear = /**
         * Whether the given year is enabled.
         * @private
         * @param {?} year
         * @return {?}
         ...
         * @return {?} The given object if it is both a date instance and valid, otherwise null.
         */
        NgxMatMultiYearView.prototype._getValidDateOrNull = /**
         * @private
         * @param {?} obj The object to check.
         * @return {?} The given object if it is both a date instance and valid, otherwise null.
         */
         ...
         * @return {?}
         */
        NgxMatMultiYearView.prototype._isRtl = /**
         * Determines whether the user has the RTL layout direction.
         * @private
         * @return {?}
         */
        ...
        /** @nocollapse */
        NgxMatMultiYearView.ctorParameters = function () {
            return [
                { type: core$1.ChangeDetectorRef },
                { type: NgxMatDateAdapter, decorators: [{ type: core$1.Optional }] },
                { type: bidi.Directionality, decorators: [{ type: core$1.Optional }] }
    ...
    var NgxMatYearView = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatYearView.ctorParameters = function () {
            return [
                { type: core$1.ChangeDetectorRef },
                { type: undefined, decorators: [{ type: core$1.Optional }, { type: core$1.Inject, args: [NGX_MAT_DATE_FORMATS,] }] },
                { type: NgxMatDateAdapter, decorators: [{ type: core$1.Optional }] },
    ...
    var NgxMatCalendarHeader = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatCalendarHeader.ctorParameters = function () {
            return [
    ...
    var NgxMatCalendar = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatCalendar.ctorParameters = function () {
            return [
                { type: datepicker.MatDatepickerIntl },
                { type: NgxMatDateAdapter, decorators: [{ type: core$1.Optional }] },
                { type: undefined, decorators: [{ type: core$1.Optional }, { type: core$1.Inject, args: [NGX_MAT_DATE_FORMATS,] }] },
    ...
    var NgxMatTimepickerComponent = /** @class */ (function () {
         ...
         */
            function (input$$1) {
                input$$1.value = input$$1.value.replace(NUMERIC_REGEX, '');
            };
        /** Toggle meridian */
        /**
         * Toggle meridian
        ...
        /** @nocollapse */
        NgxMatTimepickerComponent.ctorParameters = function () {
            return [
                { type: NgxMatDateAdapter, decorators: [{ type: core$1.Optional }] },
                { type: core$1.ChangeDetectorRef },
    ...
    var NgxMatDatetimeContent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        NgxMatDatetimeContent.ctorParameters = function () {
            return [
    ...
    var NgxMatDatetimePicker = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatDatetimePicker.ctorParameters = function () {
            return [
    ...
    var NgxMatDatetimeInput = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxMatDatetimeInput.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: NgxMatDateAdapter, decorators: [{ type: core$1.Optional }] },
                { type: undefined, decorators: [{ type: core$1.Optional }, { type: core$1.Inject, args: [NGX_MAT_DATE_FORMATS,] }] },
    ...
    var NgxMatNativeDateAdapter = /** @class */ (function (_super) {
        ...
        function NgxMatNativeDateAdapter(matDateLocale, platform$$1) {
        ...
        /** @nocollapse */
        NgxMatNativeDateAdapter.ctorParameters = function () {
            return [
    ...
    exports.ɵb = NgxMatCalendar;
    exports.ɵa = NgxMatCalendarHeader;
    exports.ɵc = NgxMatMonthView;
    exports.ɵe = NgxMatMultiYearView;
    exports.ɵd = NgxMatYearView;
